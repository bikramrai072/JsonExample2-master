package com.hackingbuzz.jsonexample2;
...
// creating object n putting .execute method in 1 line..
                 ...
                 protected String doInBackground(String... params) {
                     ...
                     try {
                         ...
                         while((textual = bufferedReader.readLine()) !=null) {
                            ...
                            return sb.toString();   // this value will go to OnPostExecute n it has got the josn value as string without parsing..we need to parse it now..
